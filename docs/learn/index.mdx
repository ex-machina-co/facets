...
A **facet** is a versioned collection of [assets](#assets) defined by a manifest (`facet.yaml`). What the author creates locally, what gets published to the registry, and what gets extracted after install.
