...
- [x] 0.4 Implement: Create `turbo.json` with `types`, `test`, `build` tasks
- [x] 0.5 Verify: `bun install` resolves workspaces; `bun check` passes
...
- [ ] 7.2 Verify: `bun check` passes (build, types, test)
